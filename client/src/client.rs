...
fn view(model: &Model) -> Vec<Node<Msg>> {
    vec![div![
        ...
        nav![
            ...
            div![
                C!["container-fluid"],
                span![C!["navbar-brand mb-3 h1"], "Dice Combat"]
            ]
        ],
                    ...
                    div![
                        ...
                        table![
                            ...
                            tbody![model.game_state.combatants.iter().map(|combatant| {
                                // combatant.
                                tr![td![&combatant.name], td![combatant.hp],]
            ...
            div![
                ...
                div![
                    ...
                    div![
                        ...
                        p![
                            C!["card-text"],
                            format!("Disconnected from server: {}", WS_URL)
                        ],
                    ]
                ]
            ]
